...
- (void)pluginInitialize
{
    ...
    if (@available(iOS 11.0, *)) {
        ...
        if (@available(iOS 13.4, *)) {} else {
            ...
            // Can potentially be removed when apple releases the fix for the issue discussed here: https://github.com/apache/cordova-ios/issues/417#issuecomment-423340885
